...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 706453123;
...
fn wire__crate__api__net_monitor__get_net_dev_stats_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                (move || {
                    let output_ok = crate::api::net_monitor::get_net_dev_stats()?;
                    Ok(output_ok)
                })(),
            )
        },
...
fn wire__crate__api__net_monitor__init_app_impl(
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok({
                        crate::api::net_monitor::init_app();
                    })?;
                    Ok(output_ok)
                })())
            }
...
impl SseDecode for Vec<crate::api::net_monitor::NetDevStat> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut len_ = <i32>::sse_decode(deserializer);
        let mut ans_ = vec![];
        for idx_ in 0..len_ {
            ans_.push(<crate::api::net_monitor::NetDevStat>::sse_decode(
                deserializer,
            ));
        }
        return ans_;
...
impl SseDecode for crate::api::net_monitor::NetDevStat {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        2 => wire__crate__api__net_monitor__init_app_impl(port, ptr, rust_vec_len, data_len),
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        1 => wire__crate__api__net_monitor__get_net_dev_stats_impl(ptr, rust_vec_len, data_len),
...
impl flutter_rust_bridge::IntoDart for crate::api::net_monitor::NetDevStat {
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::net_monitor::NetDevStat
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::net_monitor::NetDevStat>
    for crate::api::net_monitor::NetDevStat
{
    fn into_into_dart(self) -> crate::api::net_monitor::NetDevStat {
        self
    }
}
...
impl SseEncode for Vec<crate::api::net_monitor::NetDevStat> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <i32>::sse_encode(self.len() as _, serializer);
        for item in self {
            <crate::api::net_monitor::NetDevStat>::sse_encode(item, serializer);
        }
    }
}
...
impl SseEncode for crate::api::net_monitor::NetDevStat {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
